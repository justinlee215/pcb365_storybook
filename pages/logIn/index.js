    ...
    <div className={styles.container}>
      ...
      <Form className={styles.form}>
          <div className={styles.upperForm}>
            <div className={styles.upperFormBackButton}><ArrowLeftCircle onClick={ handleClickFirstTime } className={styles.backButton} size={20} aria-label="Back Button" /> </div>
            <Link href="/">
            ...
            <a className={styles.signupButton} onClick={ handleClickFirstTime}><p>Log in</p></a>
        ...
        {transition3((style, item) =>
          item ?
            ...
            <animated.div style={style}>
              ...
              <a className={styles.signupButton} onClick ={handleClickFirstTime}><p>Sign Up</p></a>
            </animated.div>
        )}
